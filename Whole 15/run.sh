...
# python3 EM.py data_set/BP_7_7_35_20 5
# echo "Checking Accuracy of learned FSAs"
# python3.7 test.py data_set/BP_7_7_35_20 5
# echo "running agent"
python3.7 FSA_Agent_combVar.py 15 7 3 6 4 7 14 15_15_0_1_0 1 0 0 data_set/BP_15_15_35_15 8 > LP_sm_1_15_0_10_1.txt
end=`date +%s`
runtime=$((end-start))
echo $runtime
echo "--------------------"
python3.7 FSA_Agent_combVar.py 15 7 3 6 4 7 14 15_15_0_3_0 3 0 0 data_set/BP_15_15_35_15 8 > LP_sm_1_15_0_10.txt
end=`date +%s`
runtime=$((end-start))
echo $runtime
echo "--------------------"

...
class FSAgent:
    ...
    def set_bound(self):
        ...
        for u, s in itertools.product(self.FSA.states, self.BP.states):
            ...
            if i%50 == 0:
                ...
                o = 0
        obj += self.m.Intermediate(o)
        self.m.Equation(obj - 17.2818 <= 0.01)
    ...
    def save_pi(self, file):
        ...
        with open('policy/'+ 'FSA_p' + sys.argv[9] + '_' + file + '.pkl', 'wb') as f:
            pickle.dump(self.pi_, f)

        with open('policy/'+ 'FSA_x' + sys.argv[9] + '_' + file + '.pkl', 'wb') as f:
...
if __name__ == '__main__':
    ...
    BP = BoxPushingConstants(int(sys.argv[1]), int(sys.argv[2]), int(sys.argv[3]), (int(sys.argv[4]), int(sys.argv[5])), g_state, (6, 3))
    FSA = FSAConstants()

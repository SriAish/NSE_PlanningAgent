...
python3.7 test.py data/Nav_15_15_25_40 6 > LP_sm_1_15_0_10_9.txt
python3.7 FSA_Agent_combVar.py 15 14 14 data/Nav_15_15_25_40 6 20 0 0 Nav_pol > Nav_res.txt
# end=`date +%s`
# runtime=$((end-start))
# echo $runtime
# start=`date +%s`
